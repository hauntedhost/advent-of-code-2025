...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `60.1µs` | `56.2µs` |
| [Day 2](./src/bin/02.rs) | `37.7ms` | `4.0ms` |
| [Day 3](./src/bin/03.rs) | `372.1µs` | `371.4µs` |
| [Day 4](./src/bin/04.rs) | `402.7µs` | `14.1ms` |
| [Day 5](./src/bin/05.rs) | `77.7µs` | `72.0µs` |
| [Day 6](./src/bin/06.rs) | `76.2µs` | `606.9µs` |
| [Day 7](./src/bin/07.rs) | `9.0ms` | `246.6µs` |
| [Day 8](./src/bin/08.rs) | `14.6ms` | `35.8ms` |
| [Day 9](./src/bin/09.rs) | `4.3ms` | `-` |
